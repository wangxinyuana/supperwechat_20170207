...
public class UserProfileActivity extends BaseActivity implements OnClickListener {
                ...
                if (s != null) {
                    ...
                    if (result != null && result.isRetMsg()) {
                        ...
                        if (user != null) {
                            ...
                            mTvUserinfoName.setText(user.getMUserNick());
                            if (!TextUtils.isEmpty(user.getAvatar())) {
                                ...
                                Glide.with(UserProfileActivity.this).load(R.drawable.default_avatar).into(mIvUserinfoAvatar);
                            }
                        }
                    }
                }
    ...
    @OnClick({R.id.img_back, R.id.txt_title, R.id.layout_userinfo_avatar, R.id.layout_userinfo_nick})
